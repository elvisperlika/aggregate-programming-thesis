...
L'obiettivo di questa tesi è dimostrare come la macroprogrammazione e le tecnologie che derivano, come il framework ScaFi e la sua estensione MacroSwarm, risultino essere un paradigma di programmazione particolarmente efficace nella la progettazione di sistemi aggregati nel caso particolare dei sistemi eterogenei.
